...
- Las tarjetas de proveedor (Luz/Agua/Gas) muestran además, como detalle chico debajo del monto, la boleta original antes de dividir (suma de `monto_total` del mes) — para que se entienda de dónde sale la parte que le toca a cada uno, y para poder notar a simple vista si una boleta quedó congelada con menos integrantes de los que hay hoy (el monto por persona coincide con el total).
